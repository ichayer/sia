...
class Perceptron:
    ...
    def evaluate_and_adjust(self, input_with_one: np.ndarray[float], expected_output: float,
        ...
        if self.output != expected_output:
            ...
            self.__delta_w += learning_rate * (expected_output - self.output) * self.theta_func.derivative(self.output,
                                                                                                           self.h) * input_with_one
        return self.output
    ...
    def adjust(self, input_data: np.ndarray[float], delta_lc_w: float, learning_rate: float) -> None:
        ...
        self.__delta_w += self.optimizer.adjust(self, gt, learning_rate)
...
class MultilayerPerceptron:
    ...
    def __init__(self, perceptron_layers: list[list[Perceptron]], optimizer: Callable[[], Optimizer]) -> None:
        ...
        for layer in perceptron_layers:
            for perceptron in layer:
                perceptron.add_optimizer(optimizer())
